...
class Exp:
	...
	def __init__(self):
		...
		self.win = visual.Window([1500,900],allowGUI=True, color="black", units='pix',checkTiming=False,screen=1)
		
		#create psychopy window for tracking trials
		self.win2 = visual.Window([800,800], color="black", allowGUI=True, units='pix',checkTiming=False,screen=2)
		# avoid flip until after init
		# self.win2.flip()
