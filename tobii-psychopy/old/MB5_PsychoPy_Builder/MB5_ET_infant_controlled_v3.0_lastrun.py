...
expInfo = {
    ...
    'conditionsFile': 'example_random_list.xlsx',
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\SoCal Lab\\Desktop\\MB5_PsychoPy_Builder\\MB5_ET_infant_controlled_v3.0_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    ROI_right = visual.Rect(
        ...
        width=(0.5, 0.5)[0], height=(0.5, 0.5)[1],
        ori=0.0, pos=(0.6, 0), draggable=False, anchor='center-right',
        lineWidth=1.0,
        colorSpace='rgb', lineColor=(0.0000, 0.0000, 0.0000), fillColor=(0.0000, 0.0000, 0.0000),
        opacity=None, depth=0.0, interpolate=True)
    ROI_left = visual.Rect(
        ...
        width=(0.5, 0.5)[0], height=(0.5, 0.5)[1],
        ori=0.0, pos=(-0.6, 0), draggable=False, anchor='center-left',
        lineWidth=1.0,
        colorSpace='rgb', lineColor=(0.0000, 0.0000, 0.0000), fillColor=(0.0000, 0.0000, 0.0000),
    ...
    imgLeft = visual.ImageStim(
        ...
        ori=0.0, pos=(-0.6, 0), draggable=False, size=(0.5, 0.5),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    trialLoop = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions(expInfo['conditionsFile']), 
        seed=None, 
        isTrials=True, 
    )
    ...
    for thisTrialLoop in trialLoop:
        ...
        minTime = float(fam_IC_time)   # time required in ROI to end routine
        maxTime = float(fam_max_time)  # maximum trial duration
        ...
        for thisTestLoop in testLoop:
            ...
            if testLoop.thisN == 0:
                imgLeft.image = image_left
                imgRight.image = image_right
            else:
                imgLeft.image = image_right
                imgRight.image = image_left
